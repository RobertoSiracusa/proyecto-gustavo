...
import os
import hashlib
from modelos import InventarioControlador, Producto
...
def ejecutar_venta(controlador, coord):
    ...
    # Hash SHA-256: determinista, mismo numero de tarjeta siempre produce el mismo ID
    hash_generado = hashlib.sha256(tarjeta_input.encode()).hexdigest()
...
def generar_reporte(controlador):
    ...
    # Dinero cobrado a partir de los gastos registrados por cada usuario
