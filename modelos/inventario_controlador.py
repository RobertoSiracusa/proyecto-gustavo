"""
Controlador de Inventario - Proyecto Maquina Expendedora
Maneja la lectura/escritura de archivos y la conexion a la API.
...
class InventarioControlador:
    ...
    def cargar_datos_locales(self):
        ...
        if not os.path.exists(self.archivo_tarjetas):
            ...
            # Deterministas: identicos en cada ejecucion y en cualquier maquina.
            def _hash(num):
                return hashlib.sha256(num.encode()).hexdigest()
            tarjetas_base = {
                _hash("1234567890"): 50.0,
                _hash("9876543210"): 100.0,
                _hash("1223334444"): 20.0,
                _hash("4444333221"): 15.5,
                _hash("1010101010"): 200.0
            }
